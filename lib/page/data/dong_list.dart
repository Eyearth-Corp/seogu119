...
class DongList {
  static final List<Dong> all = [
    ...
    Dong(name: '동천동', color: const Color(0xFFd15382),
        ...
        areaAsset: 'assets/map/dong_동천.png',
        dongTagAsset: 'assets/map/tag_동천.png',
        merchantList : [
    ...
    Dong(name: '유촌동', color: Color(0xFFc38753),
        ...
        areaAsset: 'assets/map/dong_유촌.png',
        dongTagAsset: 'assets/map/tag_유촌.png',
        merchantList : [
    ...
    Dong(name: '광천동', color: Color(0xFFabcd6e),
        ...
        areaAsset: 'assets/map/dong_광천.png',
        dongTagAsset: 'assets/map/tag_광천.png',
        merchantList : [
    ...
    Dong(name: '치평동', color: Color(0xFF6e73b5),
        ...
        areaAsset: 'assets/map/dong_치평.png',
        dongTagAsset: 'assets/map/tag_치평.png',
        merchantList : [
    ...
    Dong(name: '상무1동', color: Color(0xFF35a280),
        ...
        areaAsset: 'assets/map/dong_상무1.png',
        dongTagAsset: 'assets/map/tag_상무1.png',
        merchantList : [
    ...
    Dong(name: '화정1동', color: Color(0xFFc5acd0),
        ...
        areaAsset: 'assets/map/dong_화정1.png',
        dongTagAsset: 'assets/map/tag_화정1.png',
        merchantList : [
    ...
    Dong(name: '농성1동', color: Color(0xFF626db2),
        ...
        areaAsset: 'assets/map/dong_농성1.png',
        dongTagAsset: 'assets/map/tag_농성1.png',
        merchantList : [
    ...
    Dong(name: '양동', color: Color(0xFFf5aa4e),
        ...
        areaAsset: 'assets/map/dong_양동.png',
        dongTagAsset: 'assets/map/tag_양동.png',
        merchantList : [
    ...
    Dong(name: '상무2동', color: Color(0xFF429bd5),
        ...
        areaAsset: 'assets/map/dong_상무2.png',
        dongTagAsset: 'assets/map/tag_상무2.png',
        merchantList : [
    ...
    Dong(name: '금호1동', color: Color(0xFFe27c7a),
        ...
        areaAsset: 'assets/map/dong_금호1.png',
        dongTagAsset: 'assets/map/tag_금호1.png',
        merchantList : [
    ...
    Dong(name: '화정4동', color: Color(0xFFb960a2),
        ...
        areaAsset: 'assets/map/dong_화정4.png',
        dongTagAsset: 'assets/map/tag_화정4.png',
        merchantList : [
    ...
    Dong(name: '화정3동', color: Color(0xFFe77117),
        ...
        areaAsset: 'assets/map/dong_화정3.png',
        dongTagAsset: 'assets/map/tag_화정3.png',
        merchantList : [
    ...
    Dong(name: '화정2동', color: Color(0xFFedb2a0),
        ...
        areaAsset: 'assets/map/dong_화정2.png',
        dongTagAsset: 'assets/map/tag_화정2.png',
        merchantList : [
    ...
    Dong(name: '농성2동', color: Color(0xFFbfa37c),
        ...
        areaAsset: 'assets/map/dong_농성2.png',
        dongTagAsset: 'assets/map/tag_농성2.png',
        merchantList : [
    ...
    Dong(name: '금호2동', color: Color(0xFF8c5425),
        ...
        areaAsset: 'assets/map/dong_금호2.png',
        dongTagAsset: 'assets/map/tag_금호2.png',
        merchantList : [
    ...
    Dong(name: '풍암동', color: Color(0xFF50bdb8),
        ...
        areaAsset: 'assets/map/dong_풍암.png',
        dongTagAsset: 'assets/map/tag_풍암.png',
        merchantList : [
    ...
    Dong(name: '매월동', color: Color(0xFFe7bc3a),
        ...
        areaAsset: 'assets/map/dong_매월.png',
        dongTagAsset: 'assets/map/tag_매월.png',
        merchantList : [
