...
class Dong {
  ...
  Dong({
    ...
    required this.area,
    required this.areaAsset,
    required this.dongTagArea,
  ...
  static final List<Dong> all = [
    ...
    Dong(
      ...
      merchantList: [
        ...
        Merchant(id: 29, name: "상무1동아파트상인회", x: 884, y: 573),
        Merchant(id: 29, name: "상무1동아파트상인회", x: 1024, y: 533),
        Merchant(id: 29, name: "상무1동아파트상인회", x: 1086, y: 690),
